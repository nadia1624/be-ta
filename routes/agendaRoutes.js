...
// Leader Agenda Management routes (for Sespri & Ajudan)
router.get('/leader-agendas', authenticateToken, authorizeRoles('Sespri', 'Ajudan'), agendaController.getLeaderAgendas);
